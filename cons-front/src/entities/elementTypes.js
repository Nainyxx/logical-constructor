...
export const ELEMENT_TYPES = {
  ...
  D_TRIGGER: {
    ...
    // peek — то же Q/Q', но без вычислений, прямо из сохранённого
    // состояния. Нужен для случая, когда триггер заведён сам на себя
    // (см. entities/circuit.js): его собственный вход должен увидеть
    // значение с прошлого такта, а не пустой результат от защиты
    // от циклов.
