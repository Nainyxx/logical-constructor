...
// ---------------------------------------------------------------------
// Таблица истинности всей собранной схемы: перебираем все наборы входов
// и читаем показания выходов. Работает только для комбинационных схем —
// у схемы с памятью или обратной связью выход зависит от предыстории, и
// одной таблицей его не описать.
